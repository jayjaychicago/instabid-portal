...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div class="attribution">Dashboard by <a href="">Instabid</a></div>
	</div><!--/.sidebar-->
...
orderToTable(exchange, product, $("#orderTable"),'julienpmjacquet@gmail.com', 'class="table table-hover gradienttable" data-sort-name="Product Name" data-sort-order="desc"');
