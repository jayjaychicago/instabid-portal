...
fillToTable(exchange, product, $("#fillTable"),'julienpmjacquet@gmail.com', 'class="table table-hover gradienttable" data-sort-name="Product Name" data-sort-order="desc"');
});
