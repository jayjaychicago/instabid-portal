...
jQuery(document).ready(function ($) {
        $("#liApiDocs").addClass("active");
        $("#api-sub-item-1").addClass("in");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">API Docs / Get prices</li>
			</ol>
		</div>
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Get all prices and volumes for <?php echo $_GET["product"] ; ?> product</h1>
			</div>
		</div>
		<!--
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Get prices</div>
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="panel panel-default chat">
					...
					<div class="panel-body" >
<p>You can place get prices and volumes for a product by making a super simple API call </p>
<p>Here's a simple way to place an order:</p>
<span class="hljs-string"><XMP style="color:black; font-size: 9px; word-wrap: break-word; width:900px; white-space: pre-wrap;">

curl "http://julienjacquet.com:3000/depths/?productName=test&exchangeName=TEST"
</XMP></span>
					...
					<div class="panel-body">
						...
						<li class="todo-list-item">
								<div class="checkbox">
									...
									<label for="checkbox">Call the API</label>
								</div>
