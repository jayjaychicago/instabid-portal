	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">API Docs / Place a bid</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="panel panel-default chat">
					...
					<div class="panel-body" >
<p>You can place an order by making a super simple API call </p>
...
curl -X POST http://julienjacquet.com:3000/orders/ -d "side=S&qty=1&price=22&exchange=TEST&product=test"
</XMP></span>
