...
jQuery.getScript("http://3.140.175.176/manage/assets/instabid_realtime.js")
	.done(function() {
...
/*
    	...
    	var script = document.createElement("script");
    	script.src = protocol + "//3.140.175.176/manage/assets/instabid_realtime.js";
    	document.head.appendChild(script);
*/
	}
}
...
//                                console.log(jmsg.SELLDEPTHS[i].QTY + '/' + Math.abs(jmsg.SELLDEPTHS[i].PRICE));
		...
		divToPlaceProducts.append(finalTable);
			...
			console.log('Did not get any Message');
		}
	});
}
...
if (jFormatOptions["border"] == 1) {
	...
	table = table + '                </h6>';
	table = table + '            </div>';
	table = table + '            <div id="collapseTwo' + placeBidNumber + simpleBidAppend + '" class="panel-collapse collapse in">';
...
$("#tradeButton" + placeBidNumber +  simpleBidAppend).click(function() {
		...
		if (simpleBid) {
			var buySell = $('input[name=buySell' + placeBidNumber +  simpleBidAppend + ']').val();
                ...
                //alert("You want to trade" + $("#exchangeName").val() + $("#productName").val() + buySell + $("#qty").val() + $("#price").val() + 'julienpmjacquet@gmail.com'  );
                if (buySell == "B" || buySell == "S") {
			var fills = newOrder($("#exchangeName" + placeBidNumber + simpleBidAppend ).val() , $("#productName" + placeBidNumber +  simpleBidAppend).val() , buySell , $("#qty"  + placeBidNumber +  simpleBidAppend).val() , $("#price" + placeBidNumber +  simpleBidAppend).val() , "julienpmjacquet@gmail.com", function(msg) { 
        	//alert(msg);
...
$("#tradeButton" + buyNowNumber +  simpleBidAppend).click(function() {
		...
		if (simpleBid) {
			var buySell = $('input[name=buySell' + buyNowNumber +  simpleBidAppend + ']').val();
                ...
                if (buySell == "B" || buySell == "S") {
			var fills = newOrder($("#exchangeName" + buyNowNumber + simpleBidAppend ).val() , $("#productName" + buyNowNumber +  simpleBidAppend).val() , buySell , $("#buyNowQty"  + buyNowNumber +  simpleBidAppend).val() , $("#buyNowPrice" + buyNowNumber +  simpleBidAppend).val() , "julienpmjacquet@gmail.com", function(msg) { 
        	//alert(msg);
        	msgJson = JSON.parse(msg);
        	if (msgJson["fillCount"] == 0) { 
                	//$("#productDiv").append('<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>Warning!</strong> ' + msg + '</div>');
